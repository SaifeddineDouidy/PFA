...
const AboutUs = () => {
  return (
    // Wrap the entire section in an Element component for smooth scrolling
    <Element name='about' className="overflow-hidden py-20 lg:py-[70px] bg-[#F6F5F2] dark:bg-dark">
        ...
        <div className="flex flex-wrap items-center justify-between">
          ...
          <div className="w-full lg:w-1/2">
            <div className="flex flex-col lg:flex-row lg:-mx-4">
              ...
              <div className="px-5">
                <img className="" srcSet={aboutus} alt="" />
              </div>
            </div>
          </div>
