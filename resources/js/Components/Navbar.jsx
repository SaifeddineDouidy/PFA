        ...
        <div className="flex flex-col h-full justify-between">
          <div>
            ...
            <ul className='p-4 uppercase lg:hidden'>
              <InertiaLink className='block p-4 border-b border-gray-600 text-white hover:text-[#00df9a]' href='/'>Home</InertiaLink>
              <InertiaLink className='block p-4 border-b border-gray-600 text-white hover:text-[#00df9a]' href='/about'>About</InertiaLink>
              <InertiaLink className='block p-4 text-white hover:text-[#00df9a]' href='/contact'>Contact</InertiaLink>
            </ul>
          </div>
          <div className="flex flex-col items-center mb-4">
            <InertiaLink href='/signup'><button className="relative border-2 border-white bg-transparent px-5 py-2.5 font-medium text-white transition-colors rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white hover:bg-gray-200 hover:text-black hover:scale-105 before:absolute before:left-0 before:top-0 before:-z-10 before:h-full before:w-full before:origin-top-left before:scale-x-0 before:bg-white before:transition-transform before:duration-500 before:content-[''] hover:before:scale-x-100">
              Sign Up
            </button></InertiaLink>
            <InertiaLink href='/login'><button className=" relative border-2 border-white bg-transparent px-5 py-2.5 font-medium text-white transition-colors rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white hover:bg-gray-200 hover:text-black hover:scale-105 before:absolute before:left-0 before:top-0 before:-z-10 before:h-full before:w-full before:origin-top-left before:scale-x-0 before:bg-white before:transition-transform before:duration-500 before:content-[''] hover:before:scale-x-100">
              Login In
            </button></InertiaLink>
          </div>
        </div>
