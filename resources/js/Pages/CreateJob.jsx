...
const CreateJob = ({auth}) => {
    ...
    const {
      ...
      /*const onSubmit = (data) => { 
        data.skills = selectedOption; // Assurez-vous que selectedOption est défini correctement
        console.log(data);
        fetch("http://localhost:3001/offre-job", {
            method: "POST",
            headers: {
    ...
    <div className='max-w-screen-2xl container mx-auto xl:px-2 px-4'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-5' method="POST">
            ...
            <div className='create-job-flex'>
                <div className='lg:w-1/2 w-full'>
                    ...
                    <input type="text" defaultValue={""} {...register("jobTitle")} className='create-job-input' />
                </div>
                <div className='lg:w-1/2 w-full'>
                    <label className='block mb-2 text-lg'>Company Name</label>
                    <input type="text" placeholder="" {...register("companyName")}  className='create-job-input' />
                </div>
            </div>
            ...
            <div className='create-job-flex'>
                <div className='lg:w-1/2 w-full'>
                    ...
                    <input type="text" placeholder=" $-k" {...register("minPrice")} className='create-job-input' />
                </div>
                <div className='lg:w-1/2 w-full'>
                    <label className='block mb-2 text-lg'>Maximum Salary</label>
                    <input type="text" placeholder="$-k" {...register("maxPrice")}  className='create-job-input' />
                </div>
            </div>
        ...
        <option value="Yearly">Yearly</option>
                ...
                <div className='lg:w-1/2 w-full'>
                    ...
                    <input type="text" placeholder="Ex : Morocco" {...register("jobLocation")}  className='create-job-input' />
                </div>
            </div>
        ...
        <option value="Temporary">Temporary</option>
             ...
             {/*<div className="relative w-full px-4 max-w-full flex-grow flex-1 text-right">*/}
                                ...
                                <input  style={{backgroundColor:"rgb(0,0,139)"}} type="submit"   className='block mt-12 bg-blue text-white font-semibold px-8 py-2 rounded-sm cursor-pointer'/>
                               {/*<Link to='/'/>/*} 
